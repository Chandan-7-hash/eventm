...
SECRET_KEY = 'django-insecure-lk2if0j(i31b6+yk+78^y)u50j#od%ygb*2^%rew*um2orv1z='
...
EMAIL_HOST_USER = 'khuntiachandan26@gmail.com'
EMAIL_HOST_PASSWORD = 'yhim ucwh pevi lzrx'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_PORT = 587
